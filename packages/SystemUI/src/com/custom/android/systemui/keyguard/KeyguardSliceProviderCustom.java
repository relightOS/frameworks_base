package com.custom.android.systemui.keyguard;
...
public class KeyguardSliceProviderCustom extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderCustom> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderCustom keyguardSliceProviderCustom, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderCustom);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderCustom.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderCustom keyguardSliceProviderCustom;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderCustom = (KeyguardSliceProviderCustom) mProviderReference.get();
            }
            if (keyguardSliceProviderCustom != null) {
                keyguardSliceProviderCustom.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderCustom#onBindSlice");
        Slice slice;
